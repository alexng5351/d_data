...
export const getCoverImages = (id) => {
  ...
  return info.extensions.map((ext, index) => 
    `/aicover/assets/cover/cover${id}-${index + 1}.${ext}`
  )
}
      ...
      <div className="main-content">
        ...
        <div className="trending-section">
          ...
          <div className="trending-right">
            <img src="/aicover/assets/cover_banner.png" alt="Cover Banner" className="cover-banner" />
            <div className="trending-covers-container">
              {[1, 2, 3, 4, 5].map((id, index) => (
                <img
                  key={id}
                  src={`/aicover/assets/cover_trend/cover_trend${id}-1.png`}
                  alt={`Cover ${id}`}
