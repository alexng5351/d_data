        ...
        <div className="emoji-detail-modal-body">
          ...
          <div className="emoji-detail-right">
            <div className="emoji-detail-phone-frame">
              <img 
                src="/aicover/assets/icon_next.png" 
                alt="Previous" 
              ...
              {currentPage === 0 && (
                <>
                  <img src="/aicover/assets/chatpage.png" alt="Chat Page" className="chatpage-image" />
                  ...
                  <div className="emoji-detail-chat-bar">
                    <img 
                      src="/aicover/assets/emoji_design/basic/emoji_basic_6.png" 
                      alt="Basic 6" 
                      className="emoji-detail-chat-bar-emoji"
                      onClick={() => sendEmoji('/aicover/assets/emoji_design/basic/emoji_basic_6.png', 'Basic 6')}
                    />
                    <img 
                      src="/aicover/assets/emoji_design/basic/emoji_basic_2.png" 
                      alt="Basic 2" 
                      className="emoji-detail-chat-bar-emoji"
                      onClick={() => sendEmoji('/aicover/assets/emoji_design/basic/emoji_basic_2.png', 'Basic 2')}
                    />
                    <img 
                      src="/aicover/assets/emoji_design/basic/emoji_basic_3.png" 
                      alt="Basic 3" 
                      className="emoji-detail-chat-bar-emoji"
                      onClick={() => sendEmoji('/aicover/assets/emoji_design/basic/emoji_basic_3.png', 'Basic 3')}
                    />
                    <img 
                      src="/aicover/assets/emoji_design/basic/emoji_basic_4.png" 
                      alt="Basic 4" 
                      className="emoji-detail-chat-bar-emoji"
                      onClick={() => sendEmoji('/aicover/assets/emoji_design/basic/emoji_basic_4.png', 'Basic 4')}
                    />
                    <img 
                      src={emoji.image} 
                      alt={emoji.label} 
              ...
              {currentPage === 1 && (
                  <div className="commentpage-container">
                    <img 
                      src="/aicover/assets/commentpage.png" 
                      alt="Comment Page" 
              ...
              {currentPage === 2 && (
                <div className="storypage-container">
                  <img 
                    src="/aicover/assets/storypage.png" 
                    alt="Story Page" 
                  ...
                  <div className="storypage-emojis">
                    <img 
                      key={0}
                      src="/aicover/assets/emoji_design/basic/emoji_basic_1.png" 
                      alt="Basic 1" 
                    ...
                    <img 
                      key={4}
                      src="/aicover/assets/emoji_design/basic/emoji_basic_5.png" 
                      alt="Basic 5" 
                      className="storypage-emoji-item"
                    />
                    <img 
